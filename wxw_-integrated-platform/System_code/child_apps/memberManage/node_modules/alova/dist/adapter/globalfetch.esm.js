/**
  * alova 2.21.5 (https://alova.js.org)
...
const PromiseCls = Promise, promiseReject = (value) => PromiseCls.reject(value), ObjectCls = Object, trueValue = true, falseValue = false, JSONStringify = (value) => JSON.stringify(value), setTimeoutFn = (fn, delay = 0) => setTimeout(fn, delay), clearTimeoutTimer = (timer) => clearTimeout(timer), typeOf = (arg) => typeof arg;
    ...
    return function (elements, method) {
        ...
        return {
            ...
            onDownload: async (cb) => {
                ...
                if (!response)
                    return;
                const { headers, body } = response.clone(), reader = (_a = body === null || body === void 0 ? void 0 : body.getReader) === null || _a === void 0 ? void 0 : _a.call(body), total = Number(headers.get('Content-Length') || headers.get('content-length') || 0);
                if (total <= 0) {
                    return;
                }
                let loaded = 0;
